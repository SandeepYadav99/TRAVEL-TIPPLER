      ...
      <div className="w-full bg-white shadow-xl p-5">
        <div className="m-[2%]">
          ...
          <p className="text-[17px] font-sans">
            ...
            globetrotter or a dreamer planning your first getaway, we’re here to
            ignite your wanderlust and help you craft unforgettable travel
            experiences.
          </p>
        </div>
        <div className="m-[2%]">
          <h2 className="text-[17px] font-bold">Our Mission</h2>
          <p className="text-[17px] font-sans">
            ...
            lives, broaden horizons, and foster a deeper understanding of
            different cultures.
          </p>
        </div>
        <div className="m-[2%]">
          ...
          <p className="text-[17px] font-sans">
            ...
            blog posts are filled with insightful tips, mesmerizing photographs,
        ...
        <div className="m-[2%]">
          ...
          <p className="text-[17px] font-sans">
            ...
            escape, a budget-friendly backpacking adventure, or a
            family-friendly vacation, our itineraries are designed to optimize
            your time and ensure you make the most of every moment.
          </p>
        </div>
        <div className="m-[2%]">
          <h2 className="text-[17px] font-bold">
          ...
          <p className="text-[17px] font-sans">
            ...
            explorers, engage in discussions, and find like-minded companions
            for your next expedition.
          </p>
        </div>
        <div className="m-[2%]">
          <h2 className="text-[17px] font-bold">Why Choose TravelTippler?</h2>
          <ul className="list-disc p-3">
            <li className="text-[17px] font-sans">
        ...
        <div className="m-[2%]">
          ...
          <p className="text-[17px] font-sans">
            ...
            and together, let’s create stories that will be cherished for a
            lifetime.
          </p>
        </div>
      </div>
